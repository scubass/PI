...
/* Utilizamos char * como listElementT y strcmp como compare */
int main(void) {
	setADT set1 = newSet(strcmp);   // de ser necesario, agregar la función de comparación
	setADT set2 = newSet(strcmp);
	setADT ans = newSet(strcmp);
	int ok;
	...
	// Faltaba el test con conjuntos de un elemento
	set1 = newSet(strcmp);
	set2 = newSet(strcmp);
	ok = addElement( set1, "amelia" );
